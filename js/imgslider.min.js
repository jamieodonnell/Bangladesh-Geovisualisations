...
return i(window).on("resize",c),this.each(e).on("click touchstart",s).on("mousedown touchstart",o).on("mouseup touchend",r)},i.fn.slider.defaultOptions={initialPosition:.50,showInstruction:!0,instructionText:"Click and Drag"}}(jQuery)
